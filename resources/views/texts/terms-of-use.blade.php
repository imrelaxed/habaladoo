...
<p>Even though we don’t claim ownership of the content you publish in our Site, we do need certain licenses to your content in order to operate and enable the Services. When you upload or submit content to our Services, you grant {{ $app_settings->name }} a worldwide license to communicate, distribute, host, publicly display, publicly perform, publish, reproduce, store, and use such content.</p>
<p>By submitting your content to our Services, you also give other {{ $app_settings->name }} users the right to share your content via various social medial platforms integrated with {{ $app_settings->name }}. We do not monitor or control what others do with your content.</p>
<h3>Termination</h3>
...
<p><strong></strong>Our Site may contain links to third-party sites that are not owned or controlled by {{ $app_settings->name }}.</p>
<p>{{ $app_settings->name }} has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party sites or services. We strongly advise you to read the terms and conditions and privacy policy of any third-party site that you visit.</p>
...
<p><strong></strong>IN NO EVENT SHALL {{ $app_settings->name }} BE LIABLE TO YOU OR ANYONE ELSE FOR ANY SPECIAL, INCIDENTAL, INDIRECT, CONSEQUENTIAL, OR PUNITIVE DAMAGES WHATSOEVER. THE LIMITATIONS AND EXCLUSIONS IN THIS SECTION APPLY TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW IN YOUR JURISDICTION.</p>
